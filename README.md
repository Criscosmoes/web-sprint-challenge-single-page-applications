...
In our case, we used it to use the current URL we are currently on. useRouteMatch returns Match Object. 


1. How would you explain form validation to someone who has never programmed before?


checking if inputs match a schema. 


1. In 1-2 sentences, define end to end testing.

end to end testing is when you test your entire application. these types of test are the longest to do. 
